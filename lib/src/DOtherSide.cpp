...
void dos_webengineprofile_interceptor()
{
    ...
    qDebug() << defaultProfile->isOffTheRecord();

    // TODO: how to set cookie policy and offTheRecord?

    QWebEngineScript script;
    script.setName("plugin");
    script.setSourceCode("\"use strict\";var QWebChannelMessageTypes={signal:1,propertyUpdate:2,init:3,idle:4,debug:5,invokeMethod:6,connectToSignal:7,disconnectFromSignal:8,setProperty:9,response:10},QWebChannel=function(e,t){var s;\"object\"==typeof e&&\"function\"==typeof e.send?((s=this).transport=e,this.send=function(e){\"string\"!=typeof e&&(e=JSON.stringify(e)),s.transport.send(e)},this.transport.onmessage=function(e){var n=e.data;switch(\"string\"==typeof n&&(n=JSON.parse(n)),n.type){case QWebChannelMessageTypes.signal:s.handleSignal(n);break;case QWebChannelMessageTypes.response:s.handleResponse(n);break;case QWebChannelMessageTypes.propertyUpdate:s.handlePropertyUpdate(n);break;default:console.error(\"invalid message received:\",e.data)}},this.execCallbacks={},this.execId=0,this.exec=function(e,n){n?(s.execId===Number.MAX_VALUE&&(s.execId=Number.MIN_VALUE),e.hasOwnProperty(\"id\")?console.error(\"Cannot exec message with property id: \"+JSON.stringify(e)):(e.id=s.execId++,s.execCallbacks[e.id]=n,s.send(e))):s.send(e)},this.objects={},this.handleSignal=function(e){var n=s.objects[e.object];n?n.signalEmitted(e.signal,e.args):console.warn(\"Unhandled signal: \"+e.object+\"::\"+e.signal)},this.handleResponse=function(e){e.hasOwnProperty(\"id\")?(s.execCallbacks[e.id](e.data),delete s.execCallbacks[e.id]):console.error(\"Invalid response message received: \",JSON.stringify(e))},this.handlePropertyUpdate=function(e){for(var n in e.data){var t=e.data[n],o=s.objects[t.object];o?o.propertyUpdate(t.signals,t.properties):console.warn(\"Unhandled property update: \"+t.object+\"::\"+t.signal)}s.exec({type:QWebChannelMessageTypes.idle})},this.debug=function(e){s.send({type:QWebChannelMessageTypes.debug,data:e})},s.exec({type:QWebChannelMessageTypes.init},function(e){for(var n in e)new QObject(n,e[n],s);for(var n in s.objects)s.objects[n].unwrapProperties();t&&t(s),s.exec({type:QWebChannelMessageTypes.idle})})):console.error(\"The QWebChannel expects a transport object with a send function and onmessage callback property. Given is: transport: \"+typeof e+\", transport.send: \"+typeof e.send)};function QObject(e,n,a){this.__id__=e,(a.objects[e]=this).__objectSignals__={},this.__propertyCache__={};var r=this;function s(e,t){var o=e[0],s=e[1];r[o]={connect:function(e){\"function\"==typeof e?(r.__objectSignals__[s]=r.__objectSignals__[s]||[],r.__objectSignals__[s].push(e),t||\"destroyed\"===o||a.exec({type:QWebChannelMessageTypes.connectToSignal,object:r.__id__,signal:s})):console.error(\"Bad callback given to connect to signal \"+o)},disconnect:function(e){var n;\"function\"==typeof e?(r.__objectSignals__[s]=r.__objectSignals__[s]||[],-1!==(n=r.__objectSignals__[s].indexOf(e))?(r.__objectSignals__[s].splice(n,1),t||0!==r.__objectSignals__[s].length||a.exec({type:QWebChannelMessageTypes.disconnectFromSignal,object:r.__id__,signal:s})):console.error(\"Cannot find connection of signal \"+o+\" to \"+e.name)):console.error(\"Bad callback given to disconnect from signal \"+o)}}}function i(e,n){e=r.__objectSignals__[e];e&&e.forEach(function(e){e.apply(e,n)})}for(e in this.unwrapQObject=function(e){if(e instanceof Array){for(var n=new Array(e.length),t=0;t<e.length;++t)n[t]=r.unwrapQObject(e[t]);return n}if(!e||!e[\"__QObject*__\"]||void 0===e.id)return e;var o=e.id;if(a.objects[o])return a.objects[o];if(e.data){var s=new QObject(o,e.data,a);return s.destroyed.connect(function(){if(a.objects[o]===s){delete a.objects[o];var e,n,t=[];for(e in s)t.push(e);for(n in t)delete s[t[n]]}}),s.unwrapProperties(),s}console.error(\"Cannot unwrap unknown QObject \"+o+\" without data.\")},this.unwrapProperties=function(){for(var e in r.__propertyCache__)r.__propertyCache__[e]=r.unwrapQObject(r.__propertyCache__[e])},this.propertyUpdate=function(e,n){for(var t in n){var o=n[t];r.__propertyCache__[t]=o}for(var s in e)i(s,e[s])},this.signalEmitted=function(e,n){i(e,n)},n.methods.forEach(function(e){var n=e[0],o=e[1];r[n]=function(){for(var n,e=[],t=0;t<arguments.length;++t)\"function\"==typeof arguments[t]?n=arguments[t]:e.push(arguments[t]);a.exec({type:QWebChannelMessageTypes.invokeMethod,object:r.__id__,method:o,args:e},function(e){void 0!==e&&(e=r.unwrapQObject(e),n&&n(e))})}}),n.properties.forEach(function(e){var n=e[0],t=e[1],o=e[2];r.__propertyCache__[n]=e[3],o&&(1===o[0]&&(o[0]=t+\"Changed\"),s(o,!0)),Object.defineProperty(r,t,{configurable:!0,get:function(){var e=r.__propertyCache__[n];return void 0===e&&console.warn('Undefined value in property cache for property \"'+t+'\" in object '+r.__id__),e},set:function(e){void 0!==e?(r.__propertyCache__[n]=e,a.exec({type:QWebChannelMessageTypes.setProperty,object:r.__id__,property:n,value:e})):console.warn(\"Property setter for \"+t+\" called with undefined value!\")}})}),n.signals.forEach(function(e){s(e,!1)}),n.enums)r[e]=n.enums[e]}\"object\"==typeof module&&(module.exports={QWebChannel:QWebChannel}),function(){function n(e,n){\"message\"===e&&window.pluginOnMessage&&window.pluginOnMessage(n),\"messages\"===e&&window.pluginOnAllMessages&&window.pluginOnAllMessages(n.split(\",\"))}let t;new QWebChannel(qt.webChannelTransport,function(e){t=e.objects.plugin,t.pluginResponse.connect(n)}),window.sendMessage=function(e){t.postMessage(e)},window.toColor=function(e){e=e,t.postMessage(e)}}();");
